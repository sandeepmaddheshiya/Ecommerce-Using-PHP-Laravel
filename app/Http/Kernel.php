...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        'check.admin.profile' => \App\Http\Middleware\CheckAdminProfileStatus::class, // Updated name
        'admin.profile.check' => \App\Http\Middleware\CheckAdminProfile::class, // Updated name
